...
3. [Running Notebook](#running-notebook)
    - [Setup](#setup)
...
*Table 2. Performance evaluation of the Transformer, Deep Gravity models and their shallower-layered variants, and other baseline models.*
...
<a id='R1'></a>
[1] F. Simini, G. Barlacchi, M. Luca, L. Pappalardo, A Deep Gravity model for mobility flows generation, Nature Communications 12, 6576 (2021). https://doi.org/11.1038/s41467-021-26752-4
